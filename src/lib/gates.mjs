...
export const GATES = [
  ...
  { id: "DEC-BLOCKING", priority: "P0", rule: "DEC-001", title: "Nothing is built on a pending decision" },
  { id: "DEC-REGISTER", priority: "P1", rule: "DEC-001", title: "Decision register is well formed" },
  { id: "DEC-ASSETS", priority: "P1", rule: "DEC-005", title: "Every decided asset is where it says" },
  { id: "DEC-STACK", priority: "P1", rule: "DEC-003", title: "Stack decisions match the manifest" },
  { id: "DEC-PENDING", priority: "P2", rule: "DEC-001", title: "Open decisions are visible before release" },
